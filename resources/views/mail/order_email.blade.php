...
{{-- <br>
Please click the below link to check your order details. --}}
<br>
{{-- <a href="{{env('APP_URL')}}/my-account">Click here</a> --}}
    ...
    <tr>
        ...
        <td class="center">	
         ...
         if($item->source_max != null){
            echo '<a href="https://demo.ready3dmodels.com/download/'.$item->id.'/source_max" 
            class=""> Max </a> |';
          }
        
         if($item->source_fbx != null){
            echo '<a href="https://demo.ready3dmodels.com/download/'.$item->id.'/source_fbx" 
            class=""> FBX </a> |';
          }
         if($item->source_obj != null){
            echo '<a href="https://demo.ready3dmodels.com/download/'.$item->id.'/source_obj" 
            class=""> OBJ </a> |';
          }
         if($item->source_blend != null){
            echo '<a href="https://demo.ready3dmodels.com/download/'.$item->id.'/source_blend" 
            class=""> Blend </a> |';
          }
          if($item->source_c4d != null){
            echo '<a href="https://demo.ready3dmodels.com/download/'.$item->id.'/source_c4d" 
            class=""> C4D </a> |';
          }
