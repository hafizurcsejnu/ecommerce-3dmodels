...
<main class="main">
    <div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        <div class="container">
            <h1 class="page-title">All 3D Collections<span></span></h1>
        </div><!-- End .container -->
    </div><!-- End .page-header -->
        ...
        <div class="container">
            ...
            <div class="products">
                    ...
                    <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                        <div class="product">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="collection/{{$item->id}}">{{$item->name}}</a></h3><!-- End .product-title -->
                ...
                <div class="load-more-container text-center">
                    <a href="#" class="btn btn-outline-darker btn-load-more">More Collections <i class="icon-refresh"></i></a>
