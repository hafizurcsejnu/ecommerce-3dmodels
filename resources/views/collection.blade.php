                        ...
                        <div class="product-gallery product-gallery-vertical">
                            <div class="row">
                                <figure class="product-main-image">
                                    ...
                                    <img id="product-zoom" src="{{asset('images/collection')}}/{{$images[0]}}" data-zoom-image="{{asset('images/collection')}}/{{$images[0]}}" alt="product image">
                               ...
                               { 
                               ?>
                                    <a class="product-gallery-item <?php if($i==0) echo "active";?>" href="#" data-image="{{asset('images/collection')}}/{{$images[$i]}}" data-zoom-image="{{asset('images/collection')}}/{{$images[$i]}}">
                                        <img src="{{asset('images/collection')}}/{{$images[$i]}}" alt="product side">
                                    </a>
                                <?php } ?>
...
{{-- collection item --}}
<h2 class="text-center" style="font-size: 36px; color:rgb(129, 124, 124)">All products in this collection</h2>
