					...
					<div class="col-xl-2 col-xxl-2">
						<div class="cat-banner row no-gutters">						
							...
							<div class="col-sm-12 col-xl-12 col-xxl-12">
								<div class="banner banner-overlay">
									<a href="#">
										<img src="{{asset('frontend/images/demos/demo-14/banners/banner-6.jpg')}}" style="height: 300px!important" alt="Banner img desc">
									</a>

									<div class="banner-content">										
										<a href="{{URL::to('3dmodels-category')}}/{{$item->id}}"><h2 class="title text-center mb-4">{{$item->name}}</h2></a>

										<h3 class="banner-title text-white"><a href="{{URL::to('3dmodels-category')}}/{{$item->id}}">{{$product_count_cat}} models in this category</a></h3><!-- End .banner-title -->
