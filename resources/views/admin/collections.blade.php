        ...
        <div class="card dcard">
          <div class="card-body px-1 px-md-3">                                   
            <div role="main" class="main-content">         
              ...
              ?>             
							<img src="{{asset('images/collection')}}/{{$images[0]}}" alt="" height="40px" width="60px;">
              <?php }?>
						</td>
                        ...
                        <td class="align-middle">
                          ...
                          <span class="d-none d-lg-inline">
                              <a data-rel="tooltip" title="Delete" href="/delete-collection/{{$item->id}}" onclick="confirmDelete()" class="v-hover">
