...
@section('main_content')    
  ...
  <div class="page-content container container-plus">
    <div class="page-header pb-2">
      ...
      <a href="collections"class="btn btn-default px-3 text-95 radius-round border-2 brc-black-tp10 float-left">
                ...
                <form action="update_collection" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="msrp" class="form-control" id=""  value="{{$data->msrp}}">
                      </div>    
                    </div>
                  ...
                  <div class="form-group">
                    <label for="">Add Products: </label>                                         
                        ...
                        <input type="text" list="products" name="product_name" placeholder="Select products" class="form-control" id="product_id">
                        <button type="button" class="btn btn-default" id="add_product">Add</button>
                  ...
                  <a href="{{URL::to('collections')}}" class="btn btn-default">Cancel</a>
                </form>
