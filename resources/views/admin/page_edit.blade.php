              ...
              <div class="page-content container container-plus">               
                ...
                <form action="update_page" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="meta_description"  class="form-control"  rows="10">{{$data->meta_description}}</textarea> 
                  </div>
                  ...
                  <div class="link_area">
                    ...
                    <div class="form-group col-6 float-left">
                      ...
                      <a href="/delete-page/{{$data->id}}" onclick="confirmDelete()" class="btn btn-danger">Delete</a>
                    </form>
